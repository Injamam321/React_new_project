...
const Login = () => {
    return (
        <div className='flex items-center justify-center h-[100vh] px-4 pt-5 bg-green-950 '>
            ...
            <div className=' bg-white max-w-sm p-8 rounded-2xl text-white'>
                ...
                <div className='flex flex-col space-y-3 mt-3 '>
                    <button className='bg-red-600 py-2 rounded hover:bg-red-700 flex items-center justify-center cursor-pointer'>
                        Login with Google <FaGoogle className='ml-1' />
                    </button>

                    <button className='bg-gray-600 py-2 rounded flex items-center justify-center hover:bg-gray-900 cursor-pointer'>
