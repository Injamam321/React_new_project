            ...
            <div className='bg-white max-w-lg p-8 rounded-2xl'>
                ...
                <form onSubmit={handleRegisterForm} className='space-y-4'>
                    ...
                    <div className='relative flex items-center'>
                        ...
                        {showPass
                            ? <FaEyeSlash onClick={() => setShowPass(!showPass)} className='absolute right-3 cursor-pointer hover:text-green-600' />
                    ...
                    <div className='relative flex items-center'>
                        ...
                        {confirmPass
                            ? <FaEyeSlash onClick={() => setConfirmPass(!confirmPass)} className='absolute right-3 cursor-pointer hover:text-green-600' />
